    ...
    public partial class PrivacyPolicyViewController : UIViewController
    {
        ...
        private void InitElements()
        {
            ...
            else
            {
                ...
                headerLabel.Frame = new Rectangle(Convert.ToInt32(View.Frame.Width) / 6, Convert.ToInt32(View.Frame.Width) / 12, Convert.ToInt32(View.Frame.Width - View.Frame.Width / 7), Convert.ToInt32(View.Frame.Width) / 18);
            }
            headerView.BackgroundColor = UIColor.FromRGB(36, 43, 52);
            View.BackgroundColor = UIColor.FromRGB(36, 43, 52);
            headerLabel.Text = "Политика конфиденциальности";
            ...
            licenseTV.Text = Constants.confidentialPoliticsRu;
        }
    }
}