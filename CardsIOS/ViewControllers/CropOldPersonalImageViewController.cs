...
namespace CardsIOS
{
    public partial class CropOldPersonalImageViewController : UIViewController
    {
        public static int global_index { get; set; }
        ...
        public static bool came_from_adding = false;
        UIViewController vc;
        UIPinchGestureRecognizer pinchGesture;
        public CropOldPersonalImageViewController(IntPtr handle) : base(handle)
        {
        }
        ...
        public override void ViewDidLoad()
        {
            ...
            {
                EditViewController.ids_of_attachments.RemoveAt(global_index);
                EditViewController.images_from_server_list.RemoveAt(global_index);
                x = cadreIV.Frame.X;
                y = cadreIV.Frame.Y;
                ...
                //try { PersonalDataViewController.images_list.RemoveAt(PersonalDataViewController.current_img_id); } catch { }
                PersonalDataViewControllerNew.images_list.Add(/*PersonalDataViewController.current_img_id, */cropped_result);
        ...
        private void InitElements()
        {
            ...
            imageView.Frame = new Rectangle(0, (int)(headerView.Frame.Y + headerView.Frame.Height + headerView.Frame.Height / 2), (int)(View.Frame.Width), (int)((View.Frame.Width / 4) * 3));
