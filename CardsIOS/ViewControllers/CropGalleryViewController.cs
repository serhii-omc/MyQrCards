...
namespace CardsIOS
{
    public partial class CropGalleryViewController : UIViewController
    {
        ...
        public CropGalleryViewController(IntPtr handle) : base(handle)
        {
        }
        ...
        void RemoveImage(object sender, EventArgs e)
        {
            try
            {
                PersonalDataViewControllerNew.images_list.RemoveAt(PersonalDataViewControllerNew.current_img_id);
            }
            catch { 
            }
