...
namespace CardsIOS
{
    public partial class CropCameraViewController : UIViewController
    {
        ...
        public CropCameraViewController(IntPtr handle) : base(handle)
        {
        }
        ...
        public override void ViewDidLoad()
        {
            ...
            pinchGesture = new UIPinchGestureRecognizer(() =>
            {
                ...
                {
                    if (cadreIV.Frame.X > 0 && cadreIV.Frame.Y > (int)(headerView.Frame.Y + headerView.Frame.Height) && cadreIV.Frame.X + cadreIV.Frame.Width < View.Frame.Width && cadreIV.Frame.Y + cadreIV.Frame.Height < (View.Frame.Height - View.Frame.Width / 8))
                    {
            ...
            if (CropGalleryViewController.came_from == Constants.edit)
            ...
            readyBn.TouchUpInside += (s, e) =>
            {
                ...
                PersonalDataViewControllerNew.images_list.Add(cropped_result);
            ...
            retakeBn.Font = UIFont.FromName(Constants.fira_sans, 17f);
        }
        ...
        private void InitElements()
        {
            ...
            if (deviceModel.Contains("X"))
            {
                ...
                cancelBn.Frame = new Rectangle(Convert.ToInt32(View.Frame.Width - View.Frame.Width / 4), Convert.ToInt32(View.Frame.Width) / 12 + 20, Convert.ToInt32(View.Frame.Width) / 4, Convert.ToInt32(View.Frame.Width) / 19);
            }
            else
            {
                ...
                cancelBn.Frame = new Rectangle(Convert.ToInt32(View.Frame.Width - View.Frame.Width / 4), Convert.ToInt32(View.Frame.Width) / 12, Convert.ToInt32(View.Frame.Width) / 4, Convert.ToInt32(View.Frame.Width) / 19);
            }
            View.BackgroundColor = UIColor.FromRGB(36, 43, 52);
            headerView.BackgroundColor = UIColor.FromRGB(36, 43, 52);
            headerLabel.Text = "Фото";
            ...
            retakeBn.Frame = new Rectangle(0, 0, (int)(View.Frame.Width / 3), (int)(View.Frame.Width / 8));
            retakeBn.SetTitle("Переснять", UIControlState.Normal);
