...
namespace CardsIOS
{
    public partial class LicenseViewController : UIViewController
    {
        public LicenseViewController(IntPtr handle) : base(handle)
        {
        }
        ...
        private void InitElements()
        {
            ...
            if (deviceModel.Contains("X"))
            {
                ...
                headerLabel.Frame = new Rectangle(Convert.ToInt32(View.Frame.Width) / 5, (Convert.ToInt32(View.Frame.Width) / 12) + 20, Convert.ToInt32(View.Frame.Width - View.Frame.Width / 5), Convert.ToInt32(View.Frame.Width) / 18);
            }
            else
            {
                ...
                headerLabel.Frame = new Rectangle(Convert.ToInt32(View.Frame.Width) / 5, Convert.ToInt32(View.Frame.Width) / 12, Convert.ToInt32(View.Frame.Width- View.Frame.Width / 5), Convert.ToInt32(View.Frame.Width) / 18);
            }
            headerView.BackgroundColor = UIColor.FromRGB(36, 43, 52);
            View.BackgroundColor = UIColor.FromRGB(36, 43, 52);
            headerLabel.Text = "Условия использования";
            ...
            licenseTV.Frame = new Rectangle(10, (int)(headerView.Frame.Y + headerView.Frame.Height + 10), (int)View.Frame.Width - 20, (int)(View.Frame.Height - headerView.Frame.Height - 20));
            licenseTV.Font = UIFont.FromName(Constants.fira_sans, 17);
            licenseTV.Text = Constants.termsOfUseRu;
        }
    }
}