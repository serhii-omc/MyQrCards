...
namespace CardsAndroid.Activities
{
    ...
    public class CompanyDataActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            _backRl.Click += (s, e) => base.OnBackPressed();
            ...
            _companyAddressRl.Click += (s, e) =>
            {
                ...
                {
                    //nativeMethods.CallPremiumOptionMenu(this).Show();
            ...
            _createCardBn.Click += async (s, e) =>
            {
                ...
                if (!String.IsNullOrEmpty(CompanyEmail))
                {
                    try
                    {
                        _companyEmailEt.Text = _methods.EmailValidation(CompanyEmail);
                    }
                    catch
                    {
        ...
        {
            base.OnResume();
            CardsCreatingProcessActivity.CameFrom = Constants.creating;
            FillFields();
        }
        ...
        void ShowAlternativePopup()
        {
            ...
            popupMenu.MenuItemClick += async (s1, arg1) =>
            {
                ...
                //}
                //else
                //AreStorageAndCamPermissionsGranted();
            };
            popupMenu.Show();
        }
        ...
        private void InitElements()
        {
            ...
            _createCardBn.Text = TranslationHelper.GetString("createCard", _ci);
            _logoTv.SetTextColor(Resources.GetColor(Resource.Color.editTextLineColor));
            ...
            _conditionsTv.Click += (s, e) => //StartActivity(typeof(ConditionsActivity));
            {
        ...
        void InitConditions()
        {
            _conditionsTv.Text = TranslationHelper.GetString("byClickingCreate", _ci);
            string conditionsString = TranslationHelper.GetString("byClickingCreate", _ci) +
                               TranslationHelper.GetString("conditions", _ci) +
                               TranslationHelper.GetString("andConstentToTheProcessingYourPersonalData", _ci);
            string orangePart = TranslationHelper.GetString("conditions", _ci);
            SpannableString spannable = new SpannableString(conditionsString);
            spannable.SetSpan(new ForegroundColorSpan(Resources.GetColor(Resource.Color.buttonOrangeColor)), conditionsString.IndexOf(orangePart), (conditionsString.IndexOf(orangePart)) + (orangePart.Length), SpanTypes.ExclusiveExclusive);

            _conditionsTv.TextFormatted = spannable;
        }
