...
namespace CardsAndroid.Activities
{
    ...
    public class ConfirmEmailActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            {
                EmailValue = _emailEt.Text;
            };

            EmailValue = _databaseMethods.GetEmailFromValidTill_RepeatAfter();

            if (!String.IsNullOrEmpty(EmailValue))
                _emailEt.Text = EmailValue;
        }
        ...
        private void InitElements()
        {
            ...
            _cardsLogoIv.SetBackgroundResource(Resource.Drawable.email_confirm);
            _nextBn.Text = TranslationHelper.GetString("enter", _ci);
            _mainTextTv.Text = TranslationHelper.GetString("waitingForConfirmation", _ci);
            _infoTv.Text = TranslationHelper.GetString("confirmEmailToContinue", _ci);
