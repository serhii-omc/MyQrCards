...
{
    public class PersonalImageViewHolder : RecyclerView.ViewHolder
    {
        ...
        Activity _context;
        public PersonalImageViewHolder(View itemView, Action<int, View> listener, /*Action<int, View> longListener,*/ Activity context) : base(itemView)
        {
            _context = context;
